@testitem "mCIF ZnFe2O4" begin
    ...
    sys1 = System(cryst1, [1 => Moment(s=3/2, g=-2), 17 => Moment(s=3/2, g=-2)], :dipole; dims=(1, 1, 1), seed=0)
    ...
    sys2 = System(cryst2, [1 => Moment(s=3/2, g=-2)], :dipole; dims=(1, 1, 2), seed=0)
...
@testitem "mCIF TbSb" begin
    ...
    sys1 = System(cryst1, [1 => Moment(s=3/2, g=-2)], :dipole, seed=0)
    set_dipoles_from_mcif!(sys1, filename)

    cryst2 = Crystal(filename; override_symmetry=true, symprec=1e-2)
    cryst2 = subcrystal(cryst2, "Tb3+")
    sys2 = System(cryst2, [1 => Moment(s=3/2, g=-2)], :dipole, seed=0)

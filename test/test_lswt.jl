@testitem "Kitchen Sink" begin
    ...
    @test isapprox(disps, disps_golden; atol=1e-10)
    @test isapprox(is / (natoms * g^2), is_golden; atol=1e-10)
    ...
    @test isapprox(is_full_flattened / (natoms * g^2), is_full_golden; atol=1e-10)
end

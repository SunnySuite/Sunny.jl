@testitem "Kitchen Sink" begin
    ...
    # println(round.(disps; digits=8))
    # println(round.(is / (natoms * g^2); digits=8))
    disps_golden = [1394.44009259 1393.72800996 1393.00855126 1392.91952499 1279.23991908 1279.09456848 1278.22451853 1277.69176149 1194.36633627 1193.75008364 1191.58351967 1189.79445135 1131.4224396 1131.20277008 1065.24292786 1065.09589246 1026.64934093 1024.02834857 1022.83040631 1020.76734965 945.20239754 944.79581786 835.5450284 832.00158871 827.93950142 827.30758696 821.21658218 820.43099358 820.29454879 818.59457101 810.2070011 808.55315828 766.52441108 766.51610276 766.51382586 766.50865557 758.57985418 754.6837659 750.5725789 750.47100626 665.95457302 662.42104766 651.46556256 651.41794013 581.25818916 568.10520981 559.05370231 558.49300583 552.04376275 550.13109608 539.73357296 530.6980332 499.66148352 494.92856083 435.23370607 427.70227707 408.12870586 399.85640176 370.06934307 369.8453277 365.04951425 363.63941668 354.6480126 346.60948394 341.98916518 339.37336108 318.36371739 276.21924921 263.16105384 257.40950626 230.5394542 229.77832418 203.97168129 197.50423716 193.87937154 189.86642188 189.81580698 167.94413444 154.92356651 146.21953886]
    is_golden = [9.666e-5 0.0 0.00180788 0.0 0.00216625 0.0 0.00383513 0.0 0.0 0.01355007 0.01832741 0.0 0.001319 0.0 0.0 0.00667712 0.0 0.01558319 0.02800693 0.0 0.00778241 0.0 0.02889228 0.0 0.0 0.00974874 0.0 0.00778812 0.00727829 0.0 0.0 0.00116774 0.00019073 0.00023514 0.0 0.0 0.00219332 0.0 0.00831577 0.0 0.01652065 0.0 0.0 0.01498917 0.08363193 0.00190219 0.0 0.0 0.0 0.01711155 0.00734164 0.0 0.0 0.15141992 0.09466699 0.0 0.21463963 0.0 0.0 0.07251418 0.08727933 0.0 0.0 0.23891459 0.0 0.40154618 0.0 0.05042777 0.04544663 0.0 0.0 0.07842778 0.1923505 0.0 0.00259442 0.0 0.03780018 0.08192156 0.0 0.0]

    @test isapprox(disps, disps_golden; atol=1e-7)
    @test isapprox(is / (natoms * g^2), is_golden; atol=1e-7)
    ...
    # println(round.(is_full_flattened / (natoms * g^2); digits=10))
    is_full_golden = ComplexF64[0.0007687558 + 0.0im, 0.0004533132 - 4.89354e-5im, 0.0004685355 + 8.58128e-5im, 0.0004533132 + 4.89354e-5im, 0.0002704208 + 0.0im, 0.0002708195 + 8.04261e-5im, 0.0004685355 - 8.58128e-5im, 0.0002708195 - 8.04261e-5im, 0.0002951384 + 0.0im, 0.0 + 0.0im, 0.0 - 0.0im, 0.0 + 0.0im, 0.0 + 0.0im, 0.0 + 0.0im, 0.0 + 0.0im, 0.0 - 0.0im, 0.0 - 0.0im, 0.0 + 0.0im, 0.0002179405 + 0.0im, -0.0001143995 - 0.0002112938im, -0.0001260189 + 0.0001998957im, -0.0001143995 + 0.0002112938im, 0.0002648994 + 0.0im, -0.0001276505 - 0.0002271032im, -0.0001260189 - 0.0001998957im, -0.0001276505 + 0.0002271032im, 0.0002562124 + 0.0im, 0.0 + 0.0im, -0.0 - 0.0im, -0.0 + 0.0im, -0.0 + 0.0im, 0.0 + 0.0im, -0.0 - 0.0im, -0.0 - 0.0im, -0.0 + 0.0im, 0.0 + 0.0im, 7.50171e-5 + 0.0im, 0.000206625 + 0.0001586014im, 0.0002400554 - 0.0001101671im, 0.000206625 - 0.0001586014im, 0.0009044372 + 0.0im, 0.000428286 - 0.0008109666im, 0.0002400554 + 0.0001101671im, 0.000428286 + 0.0008109666im, 0.0009299658 + 0.0im, 0.0 + 0.0im, 0.0 - 0.0im, 0.0 - 0.0im, 0.0 + 0.0im, 0.0 + 0.0im]
    
    @test isapprox(is_full_flattened / (natoms * g^2), is_full_golden; atol=1e-7)
end
...
@testitem "Spin ladder intensities reference test" begin
    ...
    broadened_formula = intensity_formula(swt, :trace; kernel=lorentzian(0.15))
    energies = collect(0:0.1:5)

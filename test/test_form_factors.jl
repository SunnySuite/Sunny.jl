@testitem "Form factors" begin
    ...
    q2 = 0.57
    function check_ffs(keys, refs; j2_coefficient=nothing)
        for (key, ref) in zip(keys, refs)
            @test ref ≈ Sunny.compute_form_factor(FormFactor(key; j2_coefficient), q2)
        end
    end
    ...
    check_ffs(brown_keys, brown_refs)

    kobayashi_keys = ["Hf2", "Hf3", "Ta2", "Ta3", "Ta4", "W0 6s⁰5d⁶", "W0 6s¹5d⁵", "W1 6s⁰5d⁵", "W1 6s¹5d⁴", "W3", "W4", "W5", "Re0 6s⁰5d⁷", "Re0 6s¹5d⁶", "Re0 6s²5d⁵", "Re1 6s⁰5d⁶", "Re1 6s¹5d⁵", "Re2", "Re4", "Re5", "Re6", "Os0 6s⁰5d⁸", "Os0 6s¹5d⁷", "Os0 6s²5d⁶", "Os1 6s⁰5d⁷", "Os1 6s¹5d⁶", "Os2", "Os3", "Os5", "Os6", "Os7", "Ir0 6s⁰5d⁹", "Ir0 6s¹5d⁸", "Ir0 6s²5d⁷", "Ir1 6s⁰5d⁸", "Ir1 6s¹5d⁷", "Ir2", "Ir3", "Ir4", "Ir6", "Pt1", "Pt2", "Pt3", "Pt4", "Pt5", "Au1", "Au2", "Au3", "Au4", "Au5"]
    ...
    check_ffs(kobayashi_keys, kobayashi_refs)
    ...
    check_ffs(brown_singlet_keys, brown_singlet_refs; j2_coefficient = -3/43)

    kobayashi_singlet_keys = ["W0 6s²5d⁴", "W2 6s⁰5d⁴", "Re3", "Os4", "Ir5", "Pt6"]
    kobayashi_singlet_refs = [0.8792679089, 0.8960938494, 0.9161468433, 0.9293869807, 0.9387216007, 0.9460141761]
    check_ffs(kobayashi_singlet_keys, kobayashi_singlet_refs; j2_coefficient = -3/43)

    # Check error messages

    @test_throws "Provide species name and ionization state, e.g. \"Fe2\" for Fe²⁺" FormFactor("Fe")
    @test_throws "Unknown electron configuration; choose \"Ir0 6s⁰5d⁹\" or \"Ir0 6s¹5d⁸\" or \"Ir0 6s²5d⁷\"" FormFactor("Ir0")
    @test_throws "Unknown electron configuration; choose \"Ir0 6s⁰5d⁹\" or \"Ir0 6s¹5d⁸\" or \"Ir0 6s²5d⁷\"" FormFactor("Ir0a")
    @test_throws "No form factor data for \"Pr5\"; contact us if you can provide it" FormFactor("Pr5")
    @test_throws "Prefix \"H\" is not a known magnetic element" FormFactor("H0")
    @test_throws "Specify `j2_coefficient` to avoid ambiguous Landé factor for singlet 1S0" Sunny.compute_form_factor(FormFactor("Cu1"), q2)

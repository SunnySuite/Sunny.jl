@testitem "Binning" begin
    ...
    g_factor = 2
    @test isapprox(is / g_factor^2,is_golden;atol = 1e-12)
    @test all(counts .== 1.)
    ...
    @test isapprox(is_flat / g_factor^2,is_golden;atol = 1e-12)
    @test all(counts .== 1.)
    ...
    @test isapprox(is[2] / g_factor^2,is2_golden;atol = 1e-12)
    @test all(counts .== 1.)

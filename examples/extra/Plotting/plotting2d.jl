...
function aspect_ratio(
    x_panel, y_panel, x_offset, y_offset, numrows, numcols; adhoc_offset=(0.0, 0.0)
)
    corners = [
        (0, 0),
...
function plot_triangular_plaquettes(
    f,
    frames;
    colormap=:RdBu,
    colorrange=(-0.5, 0.5),
    ...
    y_panel = -ny * v₂
    aspect = aspect_ratio(
        x_panel, y_panel, x_offset, y_offset, numrows, numcols; adhoc_offset=text_offset
    )

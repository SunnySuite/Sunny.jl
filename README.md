...
- **Disordered systems** and efficient solvers for spin wave calculations on very large systems ([disordered SWT](https://sunnysuite.github.io/Sunny.jl/stable/examples/09_Disorder_KPM.html)).

...
- **Quenched disorder** in inhomogeneous systems ([Disordered intensities](https://sunnysuite.github.io/Sunny.jl/stable/examples/09_Disorder_KPM.html)).
...
Several of these features are unique to Sunny (see our [methodology papers](https://github.com/SunnySuite/Sunny.jl/wiki/Sunny-literature#methods)).

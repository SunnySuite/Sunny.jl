...
- **Long-range dipole-dipole interactions** with proper Ewald summation and customizable demagnetization tensor ([Pyrochlore dipole-dipole](https://sunnysuite.github.io/Sunny.jl/stable/examples/07_Dipole_Dipole.html)).

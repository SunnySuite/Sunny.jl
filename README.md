...
- **Quenched disorder** to model, e.g., random chemical impurities ([Disordered intensities](https://sunnysuite.github.io/Sunny.jl/stable/examples/09_Disorder_KPM.html)).
...
Some of these features are unique to Sunny (see our [methodology papers](https://github.com/SunnySuite/Sunny.jl/wiki/Sunny-literature#methods)).

...
* Add `interpolate=true` option to [`plot_intensities`](@ref) which, in some
  cases, enables smaller PDF outputs. Plotting `BandIntensities` data always
  uses interpolation ([#411](@ref)).

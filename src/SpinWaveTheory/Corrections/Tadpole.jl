...
"""
    tadpole_correction(swt::SpinWaveTheory; tol, maxevals)
...
zero-point energy of the magnons, and `δE` is the resulting gain. The
...
"""
function tadpole_correction(swt::SpinWaveTheory; tol=nothing, maxevals=nothing)

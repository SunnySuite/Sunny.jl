...
# antiferromagnet in a field. Conventions are collected in Corrections.jl and
# the monomial representation in Vertices.jl.
#
...
# summed over all cells, so only the offset difference within the contracted
# pair matters.

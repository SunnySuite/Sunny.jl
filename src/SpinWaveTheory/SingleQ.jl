...
function optimagstr(f::Function, xmin, xmax, x0) # optimizing function to get minimum energy and propagation factor.
    results = Optim.optimize(f, xmin, xmax, x0, Optim.Fminbox(Optim.BFGS()));

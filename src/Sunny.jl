...
view_crystal(cryst, dist) = error("Use `plot_crystal` instead.")
offline_viewers() = error("This function is no longer needed.")
...
function plot_crystal end
export plot_spins, plot_crystal
